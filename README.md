...
* [Don't add extensions to bash executables](./til/bash/do_not_add_extenstions_to_bash_executables.md)
...
## Python
* [Tqdm with multiprocessing](./til/python/tqdm_with_multiprocessing.md)
* [functools.partial flattens nestings automatically](./til/python/functools_partial_flattens_nestings_automatically.md)
* [Access `classmethod`s like `property` methods](./til/python/access_classmethod_like_property.md)
* [Use daemon threads to test infinite while loops](./til/python/use_daemon_threads_to_test_infinite_loop.md)
* [Use `__init_subclass__` hook to validate subclasses](./til/python/use_init_subclass_hook_to_validate_subclasses.md)
